    ...
    <div class="container-fluid">
        <div class="d-flex">
            ...
            <div class="header-search d-none d-md-flex">
                <form id="searchForm" action="<?php echo e(route("user.searchNID" , 0)); ?>" class="form-inline">
                    <?php echo csrf_field(); ?>
            ...
            <div class="d-flex mr-auto header-right-icons header-search-icon">
                ...
                <div class="dropdown profile-1">
                    ...
                    <a href="#" data-toggle="dropdown" class="nav-link pl-2 pr-2  leading-none d-flex">
									<span>
										<img src="<?php echo e($photo); ?>" alt="profile-user" class="avatar  ml-xl-3 profile-user brround cover-image">
									</span>
                        <div class="text-center mt-1 d-none d-xl-block">
                            <h6 class="text-dark mb-0 fs-13 font-weight-semibold text-capitalize"><?php echo e($name); ?></h6>
                        </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow">
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('admins.setting')); ?>">
                            <i class="dropdown-icon  mdi mdi-settings"></i> اعدادات الحساب
                        </a>
                        <a class="dropdown-item" href="https://topbuziness.com/" target="_blank">
...
<?php /**PATH /home/kariem/Desktop/Projects/new-zakat/resources/views/admin/layouts/main-header.blade.php ENDPATH**/ ?>