                ...
                <div class="card-body">
                    ...
                    <div id="child_container">
                        <div class="child-row row">
                            ...
                            <?php if (old('child_names')): ?>
                                <?php $__currentLoopData = old('child_names');
                                $__env->addLoop($__currentLoopData);
                                foreach ($__currentLoopData as $index => $child_name): $__env->incrementLoopIndices();
                                    $loop = $__env->getLastLoop(); ?>
                                    <div class="col-3">
                    ...
                    <div id="patient_container">
                        <?php if (old('patient_name')): ?>
                            <?php $__currentLoopData = old('patient_name');
                            $__env->addLoop($__currentLoopData);
                            foreach ($__currentLoopData as $index => $patient): $__env->incrementLoopIndices();
                                $loop = $__env->getLastLoop(); ?>
