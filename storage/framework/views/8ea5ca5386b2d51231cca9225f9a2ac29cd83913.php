...
<head>
    ...
    <title>Invoice</title>
    <!-- bootstrap -->
    <link rel="stylesheet" href="<?php echo e(asset('invoices/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('invoices/css/bootstrap.min.css')); ?>">
...
<body>
            ...
            <div class="pt-5 ">
                <div class="container-fluid">
                    ...
                    <h5 class="text-center mt-1 mb-3">بيان باسماء حالات الاعانه الشهريه /
                        <?php echo e(isset($setting) ? $setting->title : ''); ?></h5>
                    ...
                    <div style="display: flex; justify-content: space-between;">
                        ...
                        <p>بتاريخ <?php echo e(\Carbon\Carbon::now()->format('Y-m-d')); ?></p>
                    </div>
                    <div class="scroll">
                        <table class="table">
                            <thead>
                            ...
                            <tbody>
                                ...
                                ?>
                                <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subvention): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        
                                        <td class="text-sm font-weight-600">
                                            <?php echo e(optional($subvention)->user->wife_name ?? '---'); ?></td>
                                        <td class="text-sm font-weight-600">
                                            <?php echo e(optional($subvention)->user->wife_national_id ?? '---'); ?></td>
                                        <td><?php echo e(optional($subvention)->price); ?></td>
                                        <?php
    ...
    <script src="<?php echo e(asset('invoices/js/bootstrap.bundle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('invoices/js/feather.min.js')); ?>"></script>
    <script>
...
<?php /**PATH C:\xampp\htdocs\new-zakat\resources\views/admin/print/invoice.blade.php ENDPATH**/ ?>