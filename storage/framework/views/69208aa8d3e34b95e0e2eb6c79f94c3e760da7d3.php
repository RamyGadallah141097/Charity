<?php $__env->startSection('title'); ?>
    <?php echo e(isset($setting->title) ? $setting->title : ''); ?> | اضافة مستفيد
...
<?php $__env->startSection('content'); ?>
    ...
    <?php endif; ?>
    <form id="addForm" action="<?php echo e(route('users.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" value="<?php echo e(old('husband_name')); ?>" class="form-control"
                                    name="husband_name" placeholder="">
                            </div>
                            <div class="form-group col-md-6">
                                <label class="form-label ">اسم الزوجة</label>
                                <input type="text" value="<?php echo e(old('wife_name')); ?>" class="form-control" name="wife_name"
                                    placeholder="">
                            </div>
                            <div class="form-group col-md-6">
                                <label class="form-label "> الرقم القومى للزوج</label>
                                <input type="number" value="<?php echo e(old('husband_national_id')); ?>" class="form-control"
                                    name="husband_national_id" placeholder="">
                            </div>
                            <div class="form-group col-md-6">
                                <label class="form-label "> الرقم القومى للزوجة</label>
                                <input type="number" value="<?php echo e(old('wife_national_id')); ?>" class="form-control"
                                    name="wife_national_id" placeholder="">
                            </div>

                            <div class="form-group col-md-2">
                                <label class="form-label"> عمر الزوج</label>
                                <input type="number" value="<?php echo e(old('age_husband')); ?>" class="form-control"
                                    name="age_husband" placeholder="" readonly>
                            </div>

                            <div class="form-group col-md-2">
                                <label class="form-label"> عمر الزوجة</label>
                                <input type="number" value="<?php echo e(old('age_wife')); ?>" class="form-control" name="age_wife"
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <select name="social_status" class="form-control select2"
                                    ...
                                    <option value="<?php echo e(old('social_status')); ?>"><?php echo e(old('social_status')); ?></option>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" value="<?php echo e(old('work_type')); ?>" class="form-control" name="work_type"
                                    placeholder="">
                            </div>

                            <div class="form-group col-md-4">
                                <label class="form-label">أقرب تليفون</label>
                                <input value="<?php echo e(old('nearest_phone')); ?>" type="nubmer" class="form-control"
                                    value="<?php echo e(old('nearest_phone')); ?>" name="nearest_phone" placeholder="">
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input value="<?php echo e(old('salary')); ?>" type="number" class="form-control income-input"
                                    value="<?php echo e(old('salary')); ?>" name="salary" placeholder="">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">معاش</label>
                                <input type="number" class="form-control income-input" value="<?php echo e(old('pension')); ?>"
                                    name="pension" placeholder="">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">تأمين</label>
                                <input type="number" class="form-control income-input" value="<?php echo e(old('insurance')); ?>"
                                    name="insurance" placeholder="">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">كرامة</label>
                                <input type="number" class="form-control income-input" value="<?php echo e(old('dignity')); ?>"
                                    name="dignity" placeholder="">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">تجارة</label>
                                <input type="number" class="form-control income-input" value="<?php echo e(old('trade')); ?>"
                                    name="trade" placeholder="">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">سادات</label>
                                <input type="number" class="form-control income-input" value="<?php echo e(old('pillows')); ?>"
                                    name="pillows" placeholder="">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">غير ذلك</label>
                                <input type="number" class="form-control income-input" value="<?php echo e(old('other')); ?>"
                                    name="other" placeholder="">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">إجمالى الدخل</label>
                                <input type="number" class="form-control" value="<?php echo e(old('gross_income')); ?>"
                                    name="gross_income" id="gross_income" placeholder="" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <input type="number" class="form-control expense-input" value="<?php echo e(old('rent')); ?>"
                                    name="rent" placeholder="">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">غاز</label>
                                <input type="number" class="form-control expense-input" value="<?php echo e(old('gas')); ?>"
                                    name="gas" placeholder="">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">ديون</label>
                                <input type="number" class="form-control expense-input" value="<?php echo e(old('debt')); ?>"
                                    name="debt" placeholder="">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">مياه</label>
                                <input type="number" class="form-control expense-input" value="<?php echo e(old('water')); ?>"
                                    name="water" placeholder="">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">كهرباء</label>
                                <input type="number" class="form-control expense-input"
                                    value="<?php echo e(old('electricity')); ?>" name="electricity" placeholder="">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">جمعية</label>
                                <input type="number" class="form-control expense-input"
                                    value="<?php echo e(old('association')); ?>" name="association" placeholder="">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">طعام</label>
                                <input type="number" class="form-control expense-input" value="<?php echo e(old('food')); ?>"
                                    name="food" placeholder="">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">دراسة</label>
                                <input type="number" class="form-control expense-input" value="<?php echo e(old('study')); ?>"
                                    name="study" placeholder="">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">إجمالى النفقات</label>
                                <input type="number" class="form-control" value="<?php echo e(old('gross_expenses')); ?>"
                                    name="gross_expenses" id="gross_expenses" placeholder="" readonly>
                            </div>
                        </div>
                        ...
                        <input type="nubmer" class="form-control col-md-3 " value="<?php echo e(old('standard_living')); ?>"
                            name="standard_living" id="standard_living"readonly>
                        <hr>
                        ...
                        <div class="d-flex justify-content-between mt-3">
                            ...
                            <div class="d-flex justify-content-end mb-3">
                                <button type="button" class="btn btn-primary" id="add">
                                    <i class="fe fe-plus"></i> <?php echo e(' اضافة ابن'); ?>
                        ...
                        <div id="child_container">
                            <div class="child-row row">
                                ...
                                <?php if(old('child_names')): ?>
                                    <?php $__currentLoopData = old('child_names'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $child_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-3">
                                            <div class="form-group">
                                                <label for="child_names" class="form-control-label"> اسم الابن </label>
                                                <input type="text" class="form-control" value="<?php echo e($child_name); ?>"
                                                    name="child_names[]">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control"
                                                    value="<?php echo e(old('children_national_id')[$index] ?? ''); ?>"
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?php echo e(old('age')[$index] ?? ''); ?>" name="age[]" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?php echo e(old('schools')[$index] ?? ''); ?>" name="schools[]">
                                            </div>
                                        </div>

                                        <div class="col-2">
                                            <div class="form-group">
                                                <label for="monthly_cost" class="form-control-label"> التكلفة الشهرية
                                                </label>
                                                <input type="text" class="form-control"
                                                    value="<?php echo e(old('monthly_cost')[$index] ?? ''); ?>"
                                                    name="monthly_cost[]">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?php echo e(old('notes')[$index] ?? ''); ?>" name="notes[]">
                                            </div>
                                        </div>
                        ...
                        <div id="patient_container">
                            <?php if(old('patient_name')): ?>
                                <?php $__currentLoopData = old('patient_name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="patient-row row">
                                        <!-- Patient Name and Treatment Pay By -->
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label">اسم المريض</label>
                                                <input type="text" class="form-control" value="<?php echo e($patient); ?>"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?php echo e(old('treatment_pay_by')[$index] ?? ''); ?>"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?php echo e(old('treatment')[$index] ?? ''); ?>" name="treatment[]"
                                                    placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="type[]"
                                                    ...
                                                    <option value="1"
                                                        <?php echo e(old('type')[$index] == '1' ? 'selected' : ''); ?>>ذكر</option>
                                                    <option value="0"
                                                        <?php echo e(old('type')[$index] == '0' ? 'selected' : ''); ?>>أنثي</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?php echo e(old('doctor_name')[$index] ?? ''); ?>" name="doctor_name[]"
                                                    placeholder="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="material-switch pull-left mb-5">
                                                    <input id="is_insurance_<?php echo e($index); ?>" type="checkbox"
                                                        name="is_insurance[]" value="1"
                                                        <?php echo e(is_array(old('is_insurance')) && isset(old('is_insurance')[$index]) && old('is_insurance')[$index] == '1' ? 'checked' : ''); ?>>
                                                    <label for="is_insurance_<?php echo e($index); ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            <label class="form-label mb-4">هل له تأمين</label>
                                            <div class="material-switch pull-left mb-5">
                                                <input id="is_insurance_new" type="checkbox" name="is_insurance[]"
                                                    value="1">
                        ...
                        <textarea rows="5" class="form-control" name="Case_evaluation" id="Case_evaluation"><?php echo e(old('Case_evaluation')); ?></textarea>
...
<?php echo $__env->make('admin/layouts/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kariem/Desktop/Projects/new-zakat/resources/views/admin/users/parts/create.blade.php ENDPATH**/ ?>