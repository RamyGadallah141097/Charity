...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="p-3">
                    <h3 class="card-title"><?php echo e(isset($setting) ? $setting->title : ''); ?>
                            ...
                            <div class="col-12"> <!-- Making it take full width -->
                                <div class="card bg-secondary img-card box-secondary-shadow">
                                    <div class="d-flex justify-content-between pr-3 pl-3 pt-3 w-100">
                                        ...
                                        <span class="text-white fs-30"><?php echo e($Charity); ?> EGP</span>
...
<?php $__env->startSection('ajaxCalls'); ?>
    <script>
        ...
        showData('<?php echo e(route('safer.CharityZakat')); ?>', columns);
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin/layouts/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kariem/Desktop/Projects/new-zakat/resources/views/admin/safer/charity.blade.php ENDPATH**/ ?>