...
<div class="container">
    ...
    <div class="welcome-container">
        <h3 class="heading-secondary">مرحبا بعودتك <span class="lg"><?php echo e(isset($setting) ? $setting->title : ''); ?></span>
        </h3>
        <img
            src="<?php echo e($setting && $setting->logo ? asset('storage/' . $setting->logo) : asset('images/default-logo.png')); ?>"
            alt="logo"
...
<?php /**PATH /home/kariem/Desktop/Projects/new-zakat/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>