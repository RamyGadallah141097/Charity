<<<<<<< HEAD @extends('Admin/layouts/master') @section('title') {{ $setting->title ?? '' }} | المستفيدين @endsection
    @section('page_name') المستفيدين @endsection @section('content') <h3>المستفيد</h3>
