...
@section('title') {{ isset($setting) ? isset($setting->title) : '' }} | اقرار استلام @endsection
    ...
    <div class="row">
        <div class="col-md-12" id="printDiv">
            <div class="card" style="border: 2px double">
                ...
                <p class="text-right mt-1 mr-3" style="font-weight: bold">{{isset($setting->section)}}</p>
                <p class="text-right mt-1 mr-3" style="font-weight: bold">{{isset($setting->branch)}}</p>
                <div class="card-body" style="font-size: 20px;padding: 20px" >
                    ...
                    <p class="mt-4">{{isset($setting->title)}} المشهرة برقم {{isset($setting->vat_number)}}</p>
                    <p>
                        وعنوانها {{isset($setting->address)}}
                    </p>
                    <p>
                        {{isset($setting->sub_address)}}
                    </p>
                    ...
                    <p>بانني استلمت من {{isset($setting->address)}} مبلغ وقدره </p>
                    <p>وذلك لصرفها في /</p>
                    <p>
                        بتاريخ
                        &#160;&#160;&#160;&#160;&#160;/&#160;&#160;&#160;&#160;&#160;/{{date('Y')}}
