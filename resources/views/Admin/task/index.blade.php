    ...
    <div class="col-md-12 col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"> بنك الافكار {{($setting->title) ?? ''}}</h3>
                <div class="">
...
<script>
    var columns = [
     ...
     showData('{{route('tasks.index')}}', columns);
     deleteScript('{{route('delete_task')}}');

     showAddModal('{{route('tasks.create')}}');
     addScript();
     showEditModal('{{route('tasks.edit',':id')}}');
     editScript();
