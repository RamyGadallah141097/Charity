                    ...
                    <div class="text-center mt-3">
                        ...
                        <div class="col p-1 mt-2 pb-6">
                            <div class="float-left">
                                ...
                                <h6 class="mr-5 mt-0 mb-0">هذا الشهر</h6>
                            </div>
                            <div class="float-right">
                                ...
                                <h6 class="ml-5 pb-0 mb-0">الشهر الماضي</h6>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-12 col-xl-4">
            <div class="card">
                <div class="card-header border-bottom">
                    <h5 class="card-title">أعلي التبرعات <i class="fa fa-arrow-up text-success"></i></h5>
                </div>
                <div class="card-body">
                    @foreach ($donors as $donor)
                        <div class="clearfix row mb-4">
                            <div class="col">
                                <div class="float-right">
                                    <h5 class="mb-0"><strong>{{ $donor->name }}</strong></h5> <small
                                        class="text-muted">{{ $donor->phone }}</small>
                                </div>
                            </div>
                            <div class="col">
...
{{--                        <h2 class="mb-1  number-font"> {{$subvention->price}} جنية </h2></div>--}}
                    ...
                    <div class="mt-5">
                        <p class="mb-1 d-flex"><span class=""><i
                            ...
                            <span class="fs-13 font-weight-normal text-muted ml-2">اسم المستفيد </span> : <span
                                class="mr-auto fs-15">{{ $subvention->user->husband_name ?? 'لا يوجد' }}</span>
                        </p>
                    ...
                    <div class="row mt-6 pb-4">
                        ...
                        <div class="col-4"><a class="btn btn-secondary btn-rounded btn-block" {{-- href="{{ route('social_research', $subvention->user->id) }}" --}}>تقرير
                                بحث</a>
                        </div>
                    </div>
                </div>
