                    ...
                    <div class="col-12"> <!-- Making it take full width -->
                        <div class="card bg-secondary img-card box-secondary-shadow">
                            ...
                            <div class="d-flex justify-content-between pr-3 pl-3 pt-3 w-100">
                                ...
                                <span class="text-white fs-30"> {{$totalIn}} EGP <i class='fas fa-arrow-down'
                            ...
                            <div class="d-flex justify-content-between pr-3 pl-3 pt-3 w-100">
                                ...
                                <span class="text-white fs-30"> {{$totalOut}} EGP <i class='fas fa-arrow-up'
            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @if($pay == 1)
                            <button class="btn btn-success btn-icon text-white loan-btn" data-id="{{$id}}"> صرف القرض
                            </button>
                        @endif
                    </div>
                    <div class="card-body">
