                    ...
                    <table class="table table-striped table-bordered w-100">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $user->age_wife }}</td>
                                <td>{{ $user->social_status == 0 ? 'اعزب' : ($user->social_status == 1 ? 'متزوج' : ($user->social_status == 2 ? 'مطلق' : 'ارمل')) }}
                                </td>
                    ...
                    @if ($user->attachments)
                        ...
                        <div class="image-gallery">
                            @foreach ($attachments as $attachment)
                                <img src="{{ asset('storage/' . $attachment) }}" alt="Attachment" style="max-width: 500px"
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered w-100">
                    <thead>
                        <tr class="fw-bolder text-muted bg-light">
                            <th class="min-w-25px">اسم الابن</th>
                            <th class="min-w-25px">الرقم القومي للابن</th>
                            <th class="min-w-25px">العمر</th>
                            <th class="min-w-25px">المدرسة</th>
                            <th class="min-w-25px">التكلفة الشهرية</th>
                            <th class="min-w-25px">ملاحظات</th>
