    ...
    <div class="border-shape p-1">
        <div class="pt-5 pb-5 border-shape">
            <div class="container">
                ...
                <h5 class="text-center mt-1 mb-3"> وعنوانها كفر طنبدى -شارع البحر بعد صيدلية ناصف بجوار الاستاذ على داود
                    المحامى</h5>
                <h5 class="text-center mt-1 mb-3"> شبين الكوم - محافظة المنوفية</h5>
                <div>
                    <h5 class="text-center mt-1 mb-3"> اقر انا /
                        {{ $subventions ? $subventions->user->wife_name : '---' }}</h5>
                </div>
                ...
                <p> باننى استلمت من لجنة الزكاة بكفر طنبدى مبلغ <span> {{ $subventions?->price }} </span> جنيها فقط
                    لاغير وذلك / <span> {{ $subventions?->comment }}</span></p>
