                ...
                <div class="form-group">
                    ...
                    <select name="donation_unit_id" id="donation_unit_id" class="form-control">
                        ...
                        @foreach ($donationUnits as $unit)
                            <option value="{{ $unit->id }}" data-category-ids="{{ $unit->categories->pluck('id')->implode(',') }}" data-code="{{ $unit->code }}" {{ $donation->donation_unit_id == $unit->id ? 'selected' : '' }}>{{ $unit->name }}</option>
                        @endforeach
                    </select>
