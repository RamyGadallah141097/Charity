                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" value="{{ old('wife_name', $user->wife_name) }}" class="form-control rounded-pill" name="wife_name">
                            </div>
                            <div class="form-group col-md-6">
                                <label class="form-label font-weight-bold">الرقم القومي للمستفيد <span class="text-danger">*</span></label>
                                <input type="number" value="{{ old('husband_national_id', $user->husband_national_id) }}" class="form-control rounded-pill" name="husband_national_id" required>
                            </div>
